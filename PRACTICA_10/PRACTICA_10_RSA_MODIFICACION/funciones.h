...
long long Carmichael(long long, long long);
...
std::vector<long long> ProcesarTextoCifradoADecimal(std::string, long long);
std::string ProcesarDecimalATexto(const std::vector<long long>&, long long);
